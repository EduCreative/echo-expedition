...
import { logout, setSpeechSetting, addToast, goToAdminPanel, toggleVoiceCommands, promptToInstall, toggleAiSupport, goToProfile, goToLogin } from '../lib/actions';
import Logo from './Logo';
import AboutModal from './AboutModal';
import PronunciationKeyModal from './PronunciationKeyModal';
...
export default function Header({ isDark, toggleTheme }) {
  ...
  const [showPronunciationKey, setShowPronunciationKey] = useState(false);
  ...
  return (
    <>
      <header>
        ...
        <div className="header-controls">
          ...
          <button 
            ...
            onClick={() => setShowPronunciationKey(true)} 
            aria-label="Open Pronunciation Key" 
            title="Pronunciation Key (IPA)"
          >
          ...
          {user && !user.isAnonymous ? (
            <div className="user-profile" ref={profileRef}>
              ...
              <div className={c('profile-dropdown', { active: showProfile })}>
                <ul>
                  <li>
                    <button onClick={() => { goToProfile(); setShowProfile(false); }}>
                      <span className="icon">account_circle</span> My Profile
                    </button>
                  </li>
      ...
      {showPronunciationKey && <PronunciationKeyModal onClose={() => setShowPronunciationKey(false)} />}
    </>
  );
}