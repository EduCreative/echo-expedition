    ...
    <div className="race-end-overlay">
      <div className="race-end-modal">
        ...
        <div className="race-end-buttons">
          <button className="button" onClick={() => startListeningDrill('easy')}>Play Again</button>
...
export default function ListeningDrill() {
  ...
  const { isActive, sentences, currentSentenceIndex, streak, lives, lastResult, difficulty } = listeningDrillState;
  ...
  return (
    <div className="listening-drill-container">
      ...
      <div className="drill-hud">
          ...
          <div className="drill-hud-item difficulty">
            <span className="drill-hud-label">Difficulty</span>
            <span className="drill-hud-value" style={{ textTransform: 'capitalize' }}>{difficulty}</span>
          </div>
      </div>
