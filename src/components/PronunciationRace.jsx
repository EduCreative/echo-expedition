    ...
    <div className="race-end-overlay">
      <div className="race-end-modal">
        ...
        <div className="race-end-buttons">
          <button className="button" onClick={() => startPronunciationRace('easy')}>Play Again</button>
...
export default function PronunciationRace() {
  ...
  const { isActive, words, currentWordIndex, streak, lives, lastResult, difficulty } = pronunciationRaceState;
  ...
  return (
    <div className="pronunciation-race-container">
      ...
      <div className="race-hud">
          ...
          <div className="race-hud-item difficulty">
            <span className="race-hud-label">Difficulty</span>
            <span className="race-hud-value" style={{ textTransform: 'capitalize' }}>{difficulty}</span>
          </div>
      </div>
