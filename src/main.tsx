...
// FIX: Replaced Vite-specific `import.meta.env.PROD` with a hostname check for browser compatibility.
// This ensures the service worker is only registered on a "production" domain.
